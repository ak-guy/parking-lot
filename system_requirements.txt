...
7. Should not allow more vehicles than max cap of parking lot. If parking lot is full then need to display
   message at entrance panel and on info portal at ground floor. (Use Observer Pattern)
...
12. Should support per-hour parking fee model. First hour Rs.80, Second hour Rs.60, rest Rs.30/hour